main: main.o am_file_functions.o am_file_logic.o general_functions.o
	gcc -ansi -Wall -pedantic -g main.o am_file_functions.o am_file_logic.o general_functions.o -o main
