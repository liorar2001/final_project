main: main.o am_file_functions.o am_file_logic.o general_functions.o entry_file_functions.o obj_file_functions.o
	gcc -ansi -Wall -pedantic -g main.o am_file_functions.o am_file_logic.o general_functions.o entry_file_functions.o obj_file_functions.o -o main
...
am_file_functions.o: am_file_functions.c general_functions.h
